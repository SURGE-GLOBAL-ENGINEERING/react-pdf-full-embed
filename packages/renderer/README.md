<p align="center">
  ...
  <p align="center">
    <a href="https://www.npmjs.com/package/@surge-global-engineering/full-rpdf-renderer">
      <img src="https://img.shields.io/npm/v/@surge-global-engineering/full-rpdf-renderer.svg" />
    </a>
...
```sh
yarn add @surge-global-engineering/full-rpdf-renderer
```
...
import { PDFViewer } from '@surge-global-engineering/full-rpdf-renderer';
...
```jsx
import React from 'react';
import ReactPDF from '@surge-global-engineering/full-rpdf-renderer';
...
![](https://img.shields.io/npm/dt/@surge-global-engineering/full-rpdf-renderer.svg?style=flat)
